...
export class AuthController {
    ...
    async changePassword(@Request() req, @Body() { old_password, new_password }: ChangePasswordDto) {
        await this.authService.changePassword(req.user, old_password, new_password);
